...
import (
	...
	versioned "github.com/backup-operator/pkg/client/clientset/versioned"
	internalinterfaces "github.com/backup-operator/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/backup-operator/pkg/client/listers/mydumper/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MydumperV1alpha1().Restores(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MydumperV1alpha1().Restores(namespace).Watch(context.TODO(), options)
			},
		},
		&mydumperv1alpha1.Restore{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *restoreInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mydumperv1alpha1.Restore{}, f.defaultInformer)
}

...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/backup-operator/pkg/apis/mydumper/v1alpha1.Backup":           schema_pkg_apis_mydumper_v1alpha1_Backup(ref),
		"github.com/backup-operator/pkg/apis/mydumper/v1alpha1.BackupCondition":  schema_pkg_apis_mydumper_v1alpha1_BackupCondition(ref),
		"github.com/backup-operator/pkg/apis/mydumper/v1alpha1.BackupList":       schema_pkg_apis_mydumper_v1alpha1_BackupList(ref),
		"github.com/backup-operator/pkg/apis/mydumper/v1alpha1.BackupSpec":       schema_pkg_apis_mydumper_v1alpha1_BackupSpec(ref),
		"github.com/backup-operator/pkg/apis/mydumper/v1alpha1.BackupStatus":     schema_pkg_apis_mydumper_v1alpha1_BackupStatus(ref),
		"github.com/backup-operator/pkg/apis/mydumper/v1alpha1.CrdKind":          schema_pkg_apis_mydumper_v1alpha1_CrdKind(ref),
		"github.com/backup-operator/pkg/apis/mydumper/v1alpha1.CrdKinds":         schema_pkg_apis_mydumper_v1alpha1_CrdKinds(ref),
		"github.com/backup-operator/pkg/apis/mydumper/v1alpha1.Restore":          schema_pkg_apis_mydumper_v1alpha1_Restore(ref),
		"github.com/backup-operator/pkg/apis/mydumper/v1alpha1.RestoreCondition": schema_pkg_apis_mydumper_v1alpha1_RestoreCondition(ref),
		"github.com/backup-operator/pkg/apis/mydumper/v1alpha1.RestoreList":      schema_pkg_apis_mydumper_v1alpha1_RestoreList(ref),
		"github.com/backup-operator/pkg/apis/mydumper/v1alpha1.RestoreSpec":      schema_pkg_apis_mydumper_v1alpha1_RestoreSpec(ref),
		"github.com/backup-operator/pkg/apis/mydumper/v1alpha1.RestoreStatus":    schema_pkg_apis_mydumper_v1alpha1_RestoreStatus(ref),
...
func schema_pkg_apis_mydumper_v1alpha1_Backup(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Backup is the control script's spec",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Description: "Spec defines the behavior of a Backup",
							Ref:         ref("github.com/backup-operator/pkg/apis/mydumper/v1alpha1.BackupSpec"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/backup-operator/pkg/apis/mydumper/v1alpha1.BackupSpec"},
	}
}

func schema_pkg_apis_mydumper_v1alpha1_BackupCondition(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_pkg_apis_mydumper_v1alpha1_BackupList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "BackupList is Backup list",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/backup-operator/pkg/apis/mydumper/v1alpha1.Backup"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/backup-operator/pkg/apis/mydumper/v1alpha1.Backup"},
	}
}

func schema_pkg_apis_mydumper_v1alpha1_BackupSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "BackupSpec describes the attributes that a user creates on a mydumper",
				Type:        []string{"object"},
			},
		},
	}
...
func schema_pkg_apis_mydumper_v1alpha1_BackupStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "BackupStatus represents the current status of a mydumper.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"conditions": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/backup-operator/pkg/apis/mydumper/v1alpha1.BackupCondition"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/backup-operator/pkg/apis/mydumper/v1alpha1.BackupCondition"},
	}
}

func schema_pkg_apis_mydumper_v1alpha1_CrdKind(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				...
				Required: []string{"Kind", "Plural", "SpecName", "ShortNames", "AdditionalPrinterColums"},
			},
		},
		Dependencies: []string{
...
func schema_pkg_apis_mydumper_v1alpha1_CrdKinds(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"Restore": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/backup-operator/pkg/apis/mydumper/v1alpha1.CrdKind"),
						},
					},
					"Backup": {
						SchemaProps: spec.SchemaProps{
				...
				Required: []string{"KindsString", "Restore", "Backup"},
			},
		},
		Dependencies: []string{
			"github.com/backup-operator/pkg/apis/mydumper/v1alpha1.CrdKind"},
	}
}

func schema_pkg_apis_mydumper_v1alpha1_Restore(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Restore is the control script's spec",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Description: "Spec defines the behavior of a Restore",
							Ref:         ref("github.com/backup-operator/pkg/apis/mydumper/v1alpha1.RestoreSpec"),
						},
					},
				},
				Required: []string{"spec"},
		...
		Dependencies: []string{
			"github.com/backup-operator/pkg/apis/mydumper/v1alpha1.RestoreSpec"},
	}
}

func schema_pkg_apis_mydumper_v1alpha1_RestoreCondition(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_pkg_apis_mydumper_v1alpha1_RestoreList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "RestoreList is Restore list",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_mydumper_v1alpha1_RestoreSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "RestoreSpec describes the attributes that a user creates on a mydumper",
				Type:        []string{"object"},
			},
		},
	}
...
func schema_pkg_apis_mydumper_v1alpha1_RestoreStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "BackupStatus represents the current status of a mydumper.",
					...
					"conditions": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/backup-operator/pkg/apis/mydumper/v1alpha1.RestoreCondition"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/backup-operator/pkg/apis/mydumper/v1alpha1.RestoreCondition"},
	}
}

...
type FakeRestores struct {
	Fake *FakeMydumperV1alpha1
	ns   string
}

var restoresResource = schema.GroupVersionResource{Group: "mydumper.com", Version: "v1alpha1", Resource: "restores"}

var restoresKind = schema.GroupVersionKind{Group: "mydumper.com", Version: "v1alpha1", Kind: "Restore"}

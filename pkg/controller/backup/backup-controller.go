...
func NewBackupController(
	...
	kubeInformerFactory kubeinformers.SharedInformerFactory) *BackupController {
	...
	nbInformer := informerFactory.Mydumper().V1alpha1().Backups()
	...
	nbInformer.Informer().AddEventHandler(cache.ResourceEventHandlerFuncs{
		AddFunc: controller.createBackup,
		UpdateFunc: controller.updateBackup,
...
func (c *BackupController) createBackup(obj interface{}) {
